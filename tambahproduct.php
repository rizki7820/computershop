    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Insert New Product</h1>
          <p class="mb-4">Please insert your new product correctly.</p>
...
<?php
        ...
        $quer="SELECT max(ID_PRODUCT) as maxID FROM product";
        $hasil=mysqli_query($con,$quer);
        $row=mysqli_fetch_array($hasil);
        $ID_PRODUCT=$row['maxID'];
    ...
    ?>
            <!--form start-->
            <form role="form"  method="post" action="pinsertproduct.php" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>IMAGE</label>
                  <input type="file" name="IMAGE" class="form-control" required></textarea>
                </div>
                </div>
                <!-- /.box-body -->
                        <div class="box-footer">
                          <button type="submit" class="btn btn-primary" title="Save Product"> <i class="glyphicon glyphicon-floppy-disk"></i> Save</button>
                        </div>
                </form>
