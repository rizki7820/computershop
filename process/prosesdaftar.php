...
if(mysqli_num_rows($cekuser) > 0) {
       ...
       if(!$USERNAME || !$PASSWORD) {
           echo "<div align='center'>Masih Ada Data yang Kosong! <a href='../registration.php'>Back</a>";
            ...
            $submit = mysqli_query($koneksi,"INSERT INTO member(ID_MEMBER, USERNAME,PASSWORD,NAME,GENDER,EMAIL,CELLPHONE,ADDRESS) VALUES('$ID_MEMBER','$USERNAME','$PASSWORD','$NAME','$GENDER','$EMAIL','$CELLPHONE','$ADDRESS')");
