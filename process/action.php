 ...
 {  
      ...
      {  
           ...
           {  
                ...
                {  
                     if($_SESSION["shop"][$keys]['product_id'] == $_POST["product_id"])  
                     {  
                          $is_available++;  
                          $_SESSION["shop"][$keys]['product_quantity'] = $_SESSION["shop"][$keys]['product_quantity'] + $_POST["product_quantity"];  
                     }  
                }  
                if($is_available < 1)  
                {  
      ...
      {  
           ...
           {  
                if($_SESSION["shop"][$keys]['product_id'] == $_POST["product_id"])  
                {  
                     $_SESSION["shop"][$keys]['product_quantity'] = $_POST["quantity"];  
                }  
           }  
      }  
      $order_table .= '  
